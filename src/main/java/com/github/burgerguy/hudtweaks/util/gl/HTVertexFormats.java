...
public final class HTVertexFormats {
    ...
    public static final VertexFormatElement DISTANCE_ELEMENT = new VertexFormatElement(0, VertexFormatElement.DataType.FLOAT, VertexFormatElement.Type.GENERIC, 1);
